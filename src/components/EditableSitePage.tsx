...
export function EditableSitePage({ slug }: { slug: EditablePageSlug }) {
  ...
  const canEdit = sessionUser?.role === "admin" && (!account || hasPermission(account, "edit_pages"));
          ...
          {editing ? (
            <div className="space-y-4">
              <Textarea
                ...
                rows={16}
                className="rounded-xl bg-background/50 font-sans text-base leading-relaxed"
              />
