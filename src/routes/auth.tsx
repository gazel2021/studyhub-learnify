...
function AuthPage() {
  ...
  const ROLES: { id: Role; title: string; desc: string; icon: typeof BookOpen }[] = [
    {
      id: "student",
      title: t("auth.role.student.t"),
      desc: t("auth.role.student.d"),
      icon: BookOpen,
    },
    {
      id: "teacher",
      title: t("auth.role.teacher.t"),
      desc: t("auth.role.teacher.d"),
      icon: GraduationCap,
    },
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-10 relative overflow-hidden">
      ...
      <div
        className="pointer-events-none absolute bottom-0 end-1/4 h-[400px] w-[400px] rounded-full bg-[oklch(0.66_0.24_295)]/20 blur-[120px] animate-blob"
            ...
            {mode === "signup" && step === "role" && (
              ...
              >
                ...
                <Button
                  ...
                  className="w-full mt-6 h-12 rounded-full bg-gradient-neon text-white font-bold shadow-glow-blue"
                >
                  {t("auth.continue")}
                </Button>
              </motion.div>
            ...
            {step === "form" && mode !== "forgot" && (
              ...
              >
                  ...
                  <div>
                    ...
                    <div className="relative mt-1.5">
                      ...
                      <Input
                        ...
                        className="ps-10 h-11 rounded-xl bg-background/50"
                        required
                      />
                    </div>
                  </div>
                ...
                <Button
                  type="submit"
                  disabled={busy}
                  className="w-full h-12 rounded-full bg-gradient-neon text-white font-bold shadow-glow-blue hover:shadow-glow-purple transition-smooth"
                >
